---
layout: post
title: Hide specific columns in pivot table in Angular Pivotview component | Syncfusion
...
{% include code-snippet/pivot-grid/getting-started-cs312/src/app.module.ts %}
{% endhighlight %}
