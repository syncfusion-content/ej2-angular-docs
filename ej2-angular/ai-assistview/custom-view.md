...
You can set the type of view by using the [type](../api/ai-assistview/assistViewType) property within the `e-view` selector. It accepts two values such as `Assist`, and `Custom`.
