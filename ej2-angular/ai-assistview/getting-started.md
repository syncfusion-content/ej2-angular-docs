...
| Angular Version | Minimum Syncfusion<sup style="font-size:70%">&reg;</sup> Angular AI AssistView / Interactive Chat Version |
|-----------------|----------------------------------------------------------------------------------|
...
## Adding Syncfusion<sup style="font-size:70%">&reg;</sup> Angular AI AssistView package
