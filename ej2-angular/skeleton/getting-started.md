...
This guide uses the [Angular Skeleton component](https://www.syncfusion.com/angular-components/angular-skeleton) for demonstration. Add the Angular Skeleton component component with:
...
- Add the `@syncfusion/ej2-angular-notifications` package and peer dependencies to your `package.json`.
- Import the Skeleton component component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the Skeleton component:
