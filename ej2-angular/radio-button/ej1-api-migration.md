---
layout: post
title: Ej1 Api Migration in Angular Radio Button | Syncfusion
description: Compare Essential JS 1 and Angular Radio Button APIs to migrate labels, size, checked state, and events.
