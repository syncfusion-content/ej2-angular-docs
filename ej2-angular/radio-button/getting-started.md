...
This guide demonstrates how to create a simple RadioButton and demonstrates the basic usage of the RadioButton component in an Angular application.
...
This guide uses the [Angular RadioButton component](https://www.syncfusion.com/angular-components/angular-radio-button) for demonstration. Add the Angular RadioButton component with:
...
- Import the RadioButton component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the RadioButton component:
