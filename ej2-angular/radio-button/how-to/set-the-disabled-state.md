...
description: Learn here all about set the disabled state in Syncfusion Essential Angular Radio Button component , it's elements and more details.
...
RadioButton component can be enabled/disabled by giving [`disabled`](https://ej2.syncfusion.com/angular/documentation/api/radio-button/#change) property. To disable RadioButton component, the `disabled` property can be set as `true`.
