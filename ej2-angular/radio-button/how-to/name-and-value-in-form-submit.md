...
The [`name`](https://ej2.syncfusion.com/angular/documentation/api/radio-button#name) attribute of the Angular Radio Button is used to group RadioButton. When the Angular Radio Button are grouped in form, the checked item [`value`](https://ej2.syncfusion.com/angular/documentation/api/radio-button#value) attribute will be post to server on form submit
that can be retrieved through the name. The disabled and unchecked Angular Radio Button value will not be sent to the server on form submit.
