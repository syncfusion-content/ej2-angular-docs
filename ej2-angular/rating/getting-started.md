...
This guide demonstrates how to create a default Rating and demonstrates the basic usage of the Rating module.
...
This guide uses the [Angular Rating component](https://www.syncfusion.com/angular-components/angular-rating) for demonstration. Add the Angular Rating component component with:
...
- Import the Rating component component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the Rating component:
