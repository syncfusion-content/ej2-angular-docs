---
layout: post
title: Layouts in Angular Ribbon | Syncfusion
description: Learn how to customize the Angular Ribbon layout using the activeLayout property, with support for Classic, Simplified, and other layout modes.
control: Ribbon
