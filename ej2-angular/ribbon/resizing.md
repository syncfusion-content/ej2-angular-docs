---
layout: post
title: Resizing in Angular Ribbon | Syncfusion
description: Learn how the Angular Ribbon resizes elements automatically when space changes, with support for custom resize order in Classic and Simplified modes.
control: Ribbon
