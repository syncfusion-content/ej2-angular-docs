...
The Angular ComboBox has been provided with several options to customize each list items, group title, header, and footer elements.
...
The content of each list item within the Angular ComboBox can be customized with the help of [itemTemplate](https://ej2.syncfusion.com/angular/documentation/api/combo-box/index-default#itemtemplate) property.
...
{% include code-snippet/combobox/template-cs1/src/template.html %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight ts tabtitle="template.html" %}
{% include code-snippet/combobox/group-template-cs1/src/template.html %}
{% endhighlight %}
{% endtabs %}
...
Angular ComboBox, and any custom element can be placed as a header element using the
...
{% endhighlight %}
{% highlight ts tabtitle="template.html" %}
{% include code-snippet/combobox/header-template-cs1/src/template.html %}
{% endhighlight %}
{% endtabs %}
...
The Angular ComboBox has options to show a footer element at the bottom of the list items in the popup list. Here, you can place any custom element as a footer element using
[footerTemplate](https://ej2.syncfusion.com/angular/documentation/api/combo-box/index-default#footertemplate) property.

In the following sample, footer element displays the total number of list items present in the Angular ComboBox.
...
{% endhighlight %}
{% highlight ts tabtitle="template.html" %}
{% include code-snippet/combobox/footer-template-cs1/src/template.html %}
{% endhighlight %}
{% endtabs %}
...
The Angular ComboBox is provided with support to custom design the popup list content when no data is found and no matches found on search with the help of [noRecordsTemplate](https://ej2.syncfusion.com/angular/documentation/api/combo-box/index-default#norecordstemplate) property.
...
In the following sample, when the data fetch request fails, the Angular ComboBox displays the notification.
