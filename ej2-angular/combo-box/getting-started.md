...
The following dependencies are required to use the ComboBox component in your application.
...
To install the **Syncfusion<sup style="font-size:70%">&reg;</sup> Angular ComboBox** package, use the following command:
...
```html
<ejs-combobox [dataSource]='sportsData'></ejs-combobox>
```
