...
To get start quickly with Third-Party Integration for [Angular Rich Text Editor](https://www.syncfusion.com/angular-components/angular-rich-text-editor) component, refer to the video below.
