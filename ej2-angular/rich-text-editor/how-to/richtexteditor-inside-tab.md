---
layout: post
title: Using Rich Text Editor Inside Tab Component in Angular | Syncfusion
...
control: Rich Text Editor Inside Tab 
documentation: ug
domainurl: ##DomainURL##
---

# Rich Text Editor Inside the Tab Component
...
{% include code-snippet/rich-text-editor/how-to/richtexteditor-inside-tab-cs1/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/rich-text-editor/how-to/richtexteditor-inside-tab-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "page.domainurl/samples/rich-text-editor/how-to/richtexteditor-inside-tab-cs1" %}