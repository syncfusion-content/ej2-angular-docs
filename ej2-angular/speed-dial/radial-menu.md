---
layout: post
title: Radial Menu in Angular Speed Dial | Syncfusion
description: Render Angular Speed Dial action items as a radial menu and customize direction, angles, and offset.
...
# Radial Menu in Angular Speed Dial
...
You can modify the offset distance between action items and Angular Speed Dial button using [`offset`](https://ej2.syncfusion.com/angular/documentation/api/speed-dial/radialSettingsModel/#offset) property.
...
Below example demonstrates the radial menu settings of the Angular Speed Dial.
