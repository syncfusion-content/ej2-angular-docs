...
This guide uses the [Angular Mention component](https://www.syncfusion.com/angular-components/angular-mention) for demonstration. Add the Angular Mention component with:
...
- Import the Mention component in your application.
