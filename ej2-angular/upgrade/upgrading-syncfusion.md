...
Alternatively, upgrade to the latest version by downloading and installing the desired products from [this link](https://www.syncfusion.com/account/downloads). There is no need to uninstall existing installed versions prior to this upgrade.
