---
layout: post
title: Styles and Appearance in Angular Carousel | Syncfusion
description: Customize Angular Carousel CSS classes for items, indicators, navigators, play and pause button, and partial slide sizing.
