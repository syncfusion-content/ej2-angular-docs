---
layout: post
title: How to check MIME type before upload in Angular File Upload | Syncfusion
description: Inspect the MIME type of each file in the Angular File Upload before upload using the uploading event and surface it in an alert or your own validation flow.
...
# How to check MIME type before upload in Angular File Upload
