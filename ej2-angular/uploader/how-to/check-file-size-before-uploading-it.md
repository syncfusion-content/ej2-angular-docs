...
description: Learn here all about check file size before uploading it in Syncfusion Essential Angular Uploader component, it's elements and more.
...
{% include code-snippet/uploader/check-file-size-cs1/src/app.module.ts %}
{% endhighlight %}
