---
layout: post
title: Localization in Angular Dropdown Tree | Syncfusion
description: Localize the Angular Dropdown Tree no-records, action-failure, overflow-count, and total-count messages by overriding locale keys for any culture.
...
The following table shows the default localization keys and their corresponding text messages for the Angular Dropdown Tree in `en` culture. These keys serve as templates that display dynamic content and can be customized for any target locale:
