---
layout: post
title: Appearance in Angular Speech To Text | Syncfusion®
description: Style the Angular Speech To Text button and tooltip with custom icons, content, position, and predefined e-primary, e-success, or e-danger classes.
