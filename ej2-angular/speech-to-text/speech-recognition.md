...
{% previewsample "page.domainurl/samples/speech-to-text/speechRecognition/transcript" %}
...
{% previewsample "page.domainurl/samples/speech-to-text/speechRecognition/language" %}
...
{% previewsample "page.domainurl/samples/speech-to-text/speechRecognition/interimResults" %}
...
{% previewsample "page.domainurl/samples/speech-to-text/speechRecognition/listeningState" %}
...
{% previewsample "page.domainurl/samples/speech-to-text/speechRecognition/showTooltip" %}
...
{% previewsample "page.domainurl/samples/speech-to-text/speechRecognition/disabled" %}
