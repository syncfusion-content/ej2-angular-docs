...
This guide uses the [Angular ListBox component](https://www.syncfusion.com/angular-components/angular-listbox) for demonstration. Add the Angular ListBox component with:
...
- Import the ListBox component in your application.
