---
layout: post
title: Custom Validation in Angular DatePicker | Syncfusion
...
To achieve the client side validation in a Angular DatePicker component by using `FormValidator` function. It provides an option to customize the feedback error messages to the corresponding fields to take action to resolve the issue.
