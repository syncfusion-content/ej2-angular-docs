...
## Customizing the appearance of Angular DatePicker wrapper element
...
## Customizing the Angular DatePicker icon element

Use the following CSS to customize the Angular DatePicker icon element
...
## Customizing the Calendar popup of the Angular DatePicker
