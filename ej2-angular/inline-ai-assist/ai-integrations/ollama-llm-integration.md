...
To integrate Ollama with the Syncfusion Inline AI Assist component in your Angular application:
...
{% include code-snippet/inline-ai-assist/ai-integrations/llm-model/src/app.component.html %}
{% endhighlight %}
{% highlight ts tabtitle="app.component.ts" %}
{% include code-snippet/inline-ai-assist/ai-integrations/llm-model/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/inline-ai-assist/ai-integrations/llm-model/src/main.ts %}
{% endhighlight %}
{% highlight html tabtitle="styles.css" %}
{% include code-snippet/inline-ai-assist/ai-integrations/llm-model/src/styles.css %}
{% endhighlight %}
{% endtabs %}

{% previewsample "page.domainurl/samples/inline-ai-assist/ai-integrations/llm-model" %}
