---
layout: post
title: How to integrate Sidebar with TreeView in Angular Sidebar | Syncfusion
description: Integrate a TreeView into a docked Angular Sidebar so icons stay visible when collapsed and full text appears when expanded.
