---
layout: post
title: Animation in Angular Components | Syncfusion
description: Learn how to use the Animation utility in Syncfusion Angular components to create transition effects, control timing, and configure settings.
...
# Animation in Syncfusion® Angular Components
