...
The Angular Context Menu component can be opened and closed programmatically using the [`open`](https://ej2.syncfusion.com/angular/documentation/api/context-menu#open) and [`close`](https://ej2.syncfusion.com/angular/documentation/api/context-menu#close) methods. This programmatic control is useful for creating custom trigger events or implementing Angular Context Menu functionality in response to specific user interactions.
...
In the following example, the Angular Context Menu is opened by calling the [`open`](https://ej2.syncfusion.com/angular/documentation/api/context-menu#open) method with `top` and `left` coordinates on a button click. The Angular Context Menu is closed using the [`close`](https://ej2.syncfusion.com/angular/documentation/api/context-menu#close) method on a ContextMenu item click, and additionally closes when the user clicks anywhere outside the menu.
