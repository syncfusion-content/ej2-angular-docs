...
The following example demonstrates the functionality of the `isMultiSelection` and `values` properties by showing multiple pre-selected dates in the Angular Calendar control.
