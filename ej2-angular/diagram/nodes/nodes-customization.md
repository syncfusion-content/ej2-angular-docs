...
description: Learn here all about Nodes Customization in Syncfusion® Angular Diagram component of Syncfusion Essential® JS 2 and more.
...
Node has the inEdges and outEdges read-only properties. These properties allow you to identify all connectors that are connected to the node. You can then retrieve these connectors using the [`getObject`](https://ej2.syncfusion.com/angular/documentation/api/diagram/index-default#getobject) method in the diagram.
