---
layout: post
title: Module in Angular Gantt Chart Component | Syncfusion
description: Learn how to inject modules in the Syncfusion Angular Gantt Chart component to enable features like sorting, editing, and toolbar for optimized performance.
...
- **UI enhancements**:
  ...
  - `ReorderService`: Supports column reordering with [allowReordering](https://ej2.syncfusion.com/angular/documentation/api/gantt#allowreordering).
  - `ResizeService`: Enables column resizing with [allowResizing](https://ej2.syncfusion.com/angular/documentation/api/gantt#allowresizing).
- **Advanced features**:
