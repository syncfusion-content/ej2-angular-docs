---
layout: post
title: Immutable mode in Angular Gantt component | Syncfusion
description: Learn how to enable immutable mode in the Syncfusion Angular Gantt component for optimized task rendering and performance with large datasets.
