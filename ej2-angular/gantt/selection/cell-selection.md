...
description: Explore cell selection features in Syncfusion Angular Gantt component including single, multiple, external selection, and customization using API methods and events.
