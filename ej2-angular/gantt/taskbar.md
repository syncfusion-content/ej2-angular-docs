...
This feature can be enabled by setting the [enableMultiTaskbar](https://ej2.syncfusion.com/angular/documentation/api/gantt/#enablemultitaskbar) property value to `true`.
