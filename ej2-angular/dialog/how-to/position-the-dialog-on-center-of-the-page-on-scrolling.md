---
layout: post
title: Position dialog on page on scrolling in Angular Dialog | Syncfusion
description: Learn here all about position the dialog on center of the page on scrolling in Syncfusion Essential Angular Dialog component, it's elements and more details.
...
# Position dialog on page while scrolling in Angular Dialog Component
...
{% include code-snippet/dialog/scrolling-cs1/src/app.module.ts %}
{% endhighlight %}
