...
## Adding the Syncfusion<sup style="font-size:70%">&reg;</sup> Angular TimePicker package

To install the **Syncfusion<sup style="font-size:70%">&reg;</sup> Angular TimePicker** package, use the following command:
