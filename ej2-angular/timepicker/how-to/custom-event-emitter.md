...
The **two-way binding** in Angular TimePicker can also be achieved using the custom event binding and property binding in the controls present in two different components. To create custom event, we need to create an instance of `event emitter`.
...
{% include code-snippet/timepicker/custom-binding-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
