---
layout: post
title: How to customize the slider limits in Angular Slider | Syncfusion
description: Customize the Angular Slider limit bar background color and style by overriding the e-limits CSS class to highlight restricted zones.
