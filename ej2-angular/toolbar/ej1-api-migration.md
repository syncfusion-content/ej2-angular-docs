...
This article describes the API migration process of Angular Toolbar component from Essential<sup style="font-size:70%">&reg;</sup> JS 1 to Essential<sup style="font-size:70%">&reg;</sup> JS 2.
...
| Show item |<b>Not Applicable</b>| **Method** : hideItem(index, false)<br/> `<ejs-toolbar id="toolbar" #Toolbar> </ejs-toolbar>`<br/> **TS:**<br/>  @ViewChild('Toolbar') public ToolObj: ToolbarComponent;<br/> ToolObj.hideItem(0, false);<br/>Pass `false` as the second parameter to make the item visible.|
| Hide item |<b>Not Applicable</b>| **Method** : hideItem(index, true)<br/> `<ejs-toolbar id="toolbar" #Toolbar> </ejs-toolbar>`<br/> **TS:**<br/>@ViewChild('Toolbar') public ToolObj: ToolbarComponent;<br/>ToolObj.hideItem(0, true);<br/>Pass `true` as the second parameter to hide the item.|
...
| OverflowModes | **Property** : responsiveType <br/> `<ej-toolbar id="Accordion" [responsiveType]="popup" > </ej-toolbar>`|  **Property** : overflowMode <br/> `<ejs-toolbar id="Accordion" [overflowMode]="popup" > </ejs-toolbar>` |
...
| Enable | **Method** : enable() <br/> `<ej-toolbar id="toolbar" #Toolbar></ej-toolbar>`<br/> **TS:**<br/>@ViewChild('Toolbar') public ToolObj: ToolbarComponent;<br/> ToolObj.enable(); | **Method** : disable(false) <br/> `<ejs-toolbar id="toolbar" #Toolbar></ejs-toolbar>`<br/> **TS:**<br/>@ViewChild('Toolbar') public ToolObj: ToolbarComponent;<br/> ToolObj.disable(false);<br/>Pass `false` to enable the Toolbar. |
| Disable | **Method** : disable() <br/> `<ej-toolbar id="toolbar" #Toolbar></ej-toolbar>`<br/> **TS:**<br/>@ViewChild('Toolbar') public ToolObj: ToolbarComponent;<br/> ToolObj.disable(); | **Method** :  disable(true) <br/> `<ejs-toolbar id="toolbar" #Toolbar></ejs-toolbar>`<br/> **TS:**<br/>@ViewChild('Toolbar') public ToolObj: ToolbarComponent;<br/> ToolObj.disable(true);<br/>Pass `true` to disable the Toolbar. |
