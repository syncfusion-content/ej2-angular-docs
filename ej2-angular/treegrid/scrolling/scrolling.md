---
layout: post
title: Angular TreeGrid Scrolling | Syncfusion
description: Learn how to configure scrolling in Angular TreeGrid, including responsive sizing, sticky headers, scroll-to-row, and scrollbar options.
