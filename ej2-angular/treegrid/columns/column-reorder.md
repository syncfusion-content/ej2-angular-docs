...
The Syncfusion Angular TreeGrid component allows to reorder columns by drag and drop of a particular column header from one index to another index within the tree grid. This feature can be enabled by injecting the **ReorderService** in the provider section of your **AppModule**.
...
{% endhighlight %}
{% highlight ts tabtitle="app.module.ts" %}
{% include code-snippet/treegrid/reorder-cs2/src/app.module.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
...
The Syncfusion Tree Grid allows you to reorder columns externally, which means that using methods you can programmatically move columns around within the tree grid, based on their index or target index, or by using their field name.
...
{% endhighlight %}
{% highlight ts tabtitle="app.module.ts" %}
{% include code-snippet/treegrid/reorder-cs3/src/app.module.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
...
{% endhighlight %}
{% highlight ts tabtitle="app.module.ts" %}
{% include code-snippet/treegrid/reorder-cs5/src/app.module.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
...
{% endhighlight %}
{% highlight ts tabtitle="app.module.ts" %}
{% include code-snippet/treegrid/reorder-cs4/src/app.module.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
...
When reordering columns in the Syncfusion Angular TreeGrid component, you may want to take some specific action in response to the drag and drop events. To handle these events, you can define event handlers for the following events:
...
In the following example, we have implemented the `columnDragStart`, `columnDrag`, and `columnDrop` events in the Syncfusion TreeGrid component.
...
{% endhighlight %}
{% highlight ts tabtitle="app.module.ts" %}
{% include code-snippet/treegrid/reorder-cs6/src/app.module.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
