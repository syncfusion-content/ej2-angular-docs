---
layout: post
title: Angular TreeGrid Paging | Syncfusion
description: Learn how to use paging in Angular TreeGrid, including pagination configuration, customization, and advanced features for managing large datasets.
...
Configure paging options with the [pageSettings](https://ej2.syncfusion.com/angular/documentation/api/treegrid/pageSettings) property. The `pageSettings` object allows control over the page size, current page, page count, query string enabling, and other paging behaviors.
