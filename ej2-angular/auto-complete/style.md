...
Use the following CSS to customize the background color of focused, hovered, and active items in the suggestion list.
...
## Adding a mandatory asterisk to the placeholder and float label

You can add a mandatory asterisk (`*`) to the placeholder and float label using the `.e-input-group.e-control-wrapper.e-float-input .e-float-text::after` class.
...
{% include code-snippet/autocomplete/asterisk-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
