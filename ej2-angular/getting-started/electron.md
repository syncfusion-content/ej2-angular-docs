...
To launch the application, execute the following command lines. The Syncfusion<sup style="font-size:70%">&reg;</sup> Essential JS 2 Menu component will be rendered within the Electron framework:
