---
layout: post
title: Getting Started with Angular CLI Component | Syncfusion
description: Learn here all about getting started with Syncfusion Essential Angular CLI component, it's elements and more.
