---
layout: post
title: Expand/Collapse accordion items with checkbox in Angular | Syncfusion
...
By default, accordion items can be expanded or collapsed by clicking the item header or the expand/collapse icon within the header.

You can also expand or collapse the accordion items through external button click. In the following example, clicking the accordion item header or the expand/collapse icon within the header is prevented. Instead, the accordion items can only be expanded or collapsed using the checkbox. This requirement can be achieved with the help of accordion's [`click`](https://ej2.syncfusion.com/angular/documentation/api/accordion#click), [`expanding`](https://ej2.syncfusion.com/angular/documentation/api/accordion#expanding) events, [`expandItem`](https://ej2.syncfusion.com/angular/documentation/api/accordion#expanditem) public method and checkbox's [`change`](https://ej2.syncfusion.com/angular/documentation/api/check-box#change) event.
