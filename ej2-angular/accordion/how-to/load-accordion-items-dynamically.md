...
In the following demo, you can add the Angular Accordion content by expanding any accordion header content using
...
* Here last index is calculated to append the new Angular Accordion at the end.
