...
[noRecordsTemplate](https://ej2.syncfusion.com/angular/documentation/api/drop-down-list#norecordstemplate) and [actionFailureTemplate](https://ej2.syncfusion.com/angular/documentation/api/drop-down-list#actionfailuretemplate) &nbsp;properties according to the culture currently assigned to the Angular Dropdown List.
