...
This guide demonstrates how to create a simple TextArea component using the Angular CLI.
...
This guide uses the [Angular TextArea component](https://www.syncfusion.com/angular-components/angular-textarea) for demonstration. Add the Angular TextArea component component with:
...
- Import the TextArea component component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the TextArea component:
