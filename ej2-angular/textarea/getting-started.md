...
## Adding the Syncfusion<sup style="font-size:70%">&reg;</sup> Angular TextArea package

To install the **Syncfusion<sup style="font-size:70%">&reg;</sup> Angular TextArea** package, use the following command:
