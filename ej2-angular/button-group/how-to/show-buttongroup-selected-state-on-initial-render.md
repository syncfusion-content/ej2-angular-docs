---
layout: post
title: Show selected state on initial render in Angular | Syncfusion
...
# Show buttongroup selected state on initial render | Syncfusion
...
{% include code-snippet/button-group/default-cs8/src/app.component.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/button-group/default-cs8/src/main.ts %}
{% endhighlight %}
{% endtabs %}
