...
description: Initialize Angular Button Group programmatically with the createButtonGroup utility function from ej2-splitbuttons.
...
# How to initialize Button Group using util function in Angular
