...
3. [Setting up the Angular application](#integrate-syncfusion-angular-grid-with-django-rest-framework) - Create and configure the Angular application with the Syncfusion Angular Grid.
...
6. [Running the application](#running-the-application) - Run the Django and Angular applications locally for development.
7. [GitHub sample](#complete-sample-repository) - Explore a complete working sample available on GitHub.
