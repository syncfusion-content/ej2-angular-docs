...
| 2 | Integrate the Angular Data Grid with HotChocolate GraphQL API | [View](#integrating-syncfusion-angular-grid-with-hotchocolate-graphql) |
...
The HotChocolate GraphQL backend acts as the central data service, handling queries and mutations that power the Angular Data Grid.
