...
Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Data Grid supports version-based persistence for restoration to a specific state. 
...
The Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Data Grid component supports saving and restoring state using local storage. This feature preserves the current state of the grid, such as column order, sorting, and filtering, enabling a return to previous configurations.
...
The code below demonstrates saving and restoring the previous state of a Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Data Grid component using local storage.
