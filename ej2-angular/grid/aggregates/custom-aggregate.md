...
The custom aggregate function in the Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Data Grid component is executed differently based on the aggregation context:
