...
The Syncfusion Grid provides support for inline and dialog template editing, allowing you to customize the editing using either [Reactive](https://angular.io/guide/reactive-forms) or [Template-driven](https://angular.io/guide/forms#template-driven-forms) Forms. These forms can be utilized to add and update grid records.
