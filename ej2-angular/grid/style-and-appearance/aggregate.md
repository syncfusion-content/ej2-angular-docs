...
In this example, the **e-gridfooter** class represents the root element of the aggregate row in the grid footer. You can modify the `background-color` property to change the color of the aggregate root element.
