...
To enable server-side PDF exporting in the Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Data Grid component, include the following dependencies:
...
Passing additional parameters to the server when exporting data in the Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Data Grid provides flexibility to include extra information or customize the export process based on specific requirements.
