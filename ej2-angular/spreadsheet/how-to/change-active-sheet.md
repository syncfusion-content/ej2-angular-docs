...
{% include code-snippet/spreadsheet/change-active-sheet-cs1/app/app.component.ts %}
{% endhighlight %}
{% highlight ts tabtitle="app.module.ts" %}
{% include code-snippet/spreadsheet/change-active-sheet-cs1/app/app.module.ts %}
{% endhighlight %}
{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/spreadsheet/change-active-sheet-cs1/app/main.ts %}
{% endhighlight %}
{% endtabs %}
