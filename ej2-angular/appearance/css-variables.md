...
Similar to `Material 3`, we now offer both Light and Dark variants with `Fluent 2`. In the Fluent 2 theme, there are distinct class variables for both light and dark modes, as shown in the preview below.
