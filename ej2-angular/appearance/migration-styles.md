---
layout: post
title: Migrating Styles to Theme Packages in Angular | Syncfusion
description: Learn how to migrate Syncfusion Angular component styles from component packages to theme packages with centralized SCSS and CSS references.
control: Theme
