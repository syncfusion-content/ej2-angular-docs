...
This guide uses the [Angular Badge component](https://www.syncfusion.com/angular-components/angular-badge) for demonstration. Add the Angular Badge component component with:
...
- Import the Badge component component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the Badge component:
