...
## Adding the Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Badge package

To install the **Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Badge** package, use the following command:
...
```html
    <div id='element'><h1>Badge Component <span class="e-badge">New</span></h1></div>
```
