---
layout: post
title: Footer in Angular Chat UI | Syncfusion®
description: Show or hide the Angular Chat UI footer to control the message input field and send button in your chat interface.
