...
This guide demonstrates how to create a simple Button and demonstrate the basic usage of the Button component in an Angular environment.
...
This guide uses the [Angular Buttons Component](https://www.syncfusion.com/angular-components/angular-button) for demonstration. Add the Angular Buttons component with:
...
- Import the Buttons component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the Buttons component:
