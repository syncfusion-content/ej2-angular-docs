---
layout: post
title: DateTime Format in Angular DateTime Picker | Syncfusion®
description: Learn how to set the date and time format in the Syncfusion Angular DateTime Picker using the format property with standard or custom patterns.
...
# DateTime Format in Angular DateTime Picker

## Date time Format

Date time format is a way of representing the date and time value in different string format in textbox.

By default the Angular DateTime Picker's format is based on the culture. You can also set the own custom format by using the [`format`](https://ej2.syncfusion.com/angular/documentation/api/datetimepicker#format) property.
...
The following example demonstrates the Angular DateTime Picker with the custom format (`yyyy-MM-dd hh:mm`).
...
The following example demonstrates the Angular DateTime Picker with multiple input formats.
