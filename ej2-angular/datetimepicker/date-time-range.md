...
Angular DateTime Picker provides an option to select a date and time value within a specified range by using the [`min`](https://ej2.syncfusion.com/angular/documentation/api/datetimepicker#min) and [`max`](https://ej2.syncfusion.com/angular/documentation/api/datetimepicker#max)properties.
...
Angular DateTime Picker provides an option to select a time value within a specified range by using the [`minTime`](https://ej2.syncfusion.com/angular/documentation/api/datetimepicker#minTime) and [`maxTime`](https://ej2.syncfusion.com/angular/documentation/api/datetimepicker#maxTime)properties.
