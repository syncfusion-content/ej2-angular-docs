...
Import predefined conditions into the Angular Query Builder UI for viewing or editing. Supported formats include JSON, SQL (Inline, Parameter, and Named Parameter), and MongoDB queries. Importing accelerates setup by allowing you to load pre-configured rules from external sources or saved states.
...
Initialize the Angular Query Builder UI with predefined conditions by setting the [`rule`](https://ej2.syncfusion.com/angular/documentation/api/query-builder/index-default#rule) property with a structured JSON object.
...
Update Angular Query Builder UI conditions after rendering using the [`setRules`](https://ej2.syncfusion.com/angular/documentation/api/query-builder/index-default#setrules) method with a structured JSON object.
...
Import SQL queries into the Angular Query Builder UI for direct integration and conversion to Query Builder rules. SQL import supports three types: Inline SQL, Parameter SQL, and Named Parameter SQL, enhancing workflow efficiency and data accuracy.

#### Importing from Inline SQL Query

Convert Inline SQL queries directly into Angular Query Builder UI rules using the [`setRulesFromSql`](https://ej2.syncfusion.com/angular/documentation/api/query-builder/index-default#setrulesfromsql) method. This approach streamlines SQL-to-query-builder conversion for analysis and further processing.
...
Exporting to MongoDB Query involves converting the defined conditions within the Angular Query Builder UI into MongoDB query syntax. This process allows users to generate MongoDB queries representing the conditions set in the Angular Query Builder UI, which can then be executed directly on a MongoDB database or used for further analysis and processing. This can be accomplished using the [`getMongoQuery`](https://ej2.syncfusion.com/angular/documentation/api/query-builder/index-default#getmongoquery) method for exporting to MongoDB query.
