...
description: Step-by-step guide to install and set up the Syncfusion MCP Server in VS Code, Cursor, and Code Studio for AI-powered Angular development.
...
Syncfusion<sup style="font-size:70%">&reg;</sup> MCP Server provide AI-powered assistance for building Angular applications with Syncfusion components. This guide will help you install and configure the MCP Server in your development environment.
