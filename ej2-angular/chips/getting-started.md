...
This guide demonstrates the steps required to create a simple `Chips` instance and demonstrates the basic usage of the Chips component in an Angular environment.
...
This guide uses the [Angular Chips Component](https://www.syncfusion.com/angular-components/angular-chips) for demonstration. Add the Angular Chips component with:
...
- Import the Chips component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the Chips component:
