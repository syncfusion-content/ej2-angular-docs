...
You can decide the mode in which the Tooltip is to be opened on a page, i.e., on hovering, focusing, or clicking on the target elements by using the [`opensOn`](https://ej2.syncfusion.com/angular/documentation/api/tooltip/#openson) property.
...
With this mode set to `true`, Tooltips will remain on the screen until the close icon is pressed. In this mode, close icon is attached to the Tooltip located at the top right corner. This mode can be enabled or disabled using the [`isSticky`](https://ej2.syncfusion.com/angular/documentation/api/tooltip/#issticky) property.
...
The Tooltips can be opened or closed after some delay by using the [`openDelay`](https://ej2.syncfusion.com/angular/documentation/api/tooltip/#opendelay) and [`closeDelay`](https://ej2.syncfusion.com/angular/documentation/api/tooltip/#closedelay) properties.
