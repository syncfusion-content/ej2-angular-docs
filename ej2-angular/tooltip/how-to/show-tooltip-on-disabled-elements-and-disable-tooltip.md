...
By default, Angular Tooltip do not display on disabled elements. However, you can enable this behavior by following the steps below.
...
3. Initialize the Angular Tooltip for the outer `div` element.
