...
Note: To use the DateTime axis, inject `DateTime` into the `provide` option and set the [`valueType`](https://ej2.syncfusion.com/angular/documentation/api/chart/axisDirective#valuetype) property of the axis to `DateTime`.
