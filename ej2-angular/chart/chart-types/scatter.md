...
Use the [`border`](https://ej2.syncfusion.com/angular/documentation/api/chart/emptyPointSettingsModel#border) property to configure the border width, color, and dasharray of the scatter series.
