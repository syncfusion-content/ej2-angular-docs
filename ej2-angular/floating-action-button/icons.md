...
You can show icon only in Angular Floating Action Button by setting [`iconCss`](https://ej2.syncfusion.com/angular/documentation/api/floating-action-button/fab/#iconcss) property. You can show tooltip on hover to show additional details to end-user by setting `title` attribute.
...
@Component({
    selector: 'app-root',
    template: ` <!-- To Render Angular Floating Action Button with icon only -->
...
You can show icon along with text in Angular Floating Action Button by setting [`iconCss`](https://ej2.syncfusion.com/angular/documentation/api/floating-action-button/fab/#iconcss) and [`content`](https://ej2.syncfusion.com/angular/documentation/api/floating-action-button/fab/#content) properties.
...
@Component({
    selector: 'app-root',
    template: `<!-- To Render Angular Floating Action Button with icon and text -->
...
@Component({
    selector: 'app-root',
    template: `<!-- To Render Angular Floating Action Button with icon position -->
