...
This guide demonstrates how to create a Split Button and demonstrates the basic usage of the component in an Angular application.
...
This guide uses the [Angular SplitButton component](https://www.syncfusion.com/angular-components/angular-split-button) for demonstration. Add the Angular SplitButton component component with:
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the SplitButton component:
