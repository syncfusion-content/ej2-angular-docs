...
The Angular Avatar component provides extensive customization capabilities for colors, sizes, shapes, and media formats. This section demonstrates how to modify the Angular Avatar's appearance to match specific design requirements and integrate various content types.

## Color customization

The Angular Avatar displays with a default grey background color. This can be customized to any desired color by adding a custom CSS class or directly targeting the avatar class in the stylesheet.
...
## Customize Angular Avatar sizes

The Angular Avatar component includes five predefined size classes. For sizes beyond these predefined options, the Angular Avatar is designed with width and height relative to font-size. Changing the `font-size` of the avatar element automatically adjusts its width and height proportionally.
...
Angular Avatars support a wide variety of media formats including SVG, font icons, images, letters, and words. The following example demonstrates these different content types.
