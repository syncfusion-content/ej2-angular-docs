...
Angular ListView can be customized as a chat window interface. To achieve this functionality, use the Angular ListView [template](https://ej2.syncfusion.com/angular/documentation/api/list-view/index-default#template) property and [Avatar](https://ej2.syncfusion.com/angular/documentation/avatar/getting-started) component.
