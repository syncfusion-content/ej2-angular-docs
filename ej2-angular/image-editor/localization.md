...
The `L10n` library from `@syncfusion/ej2-base` allows you to localize the default text content of the Angular Image Editor. The Angular Image Editor has static text that can be changed to other cultures (Arabic, Deutsch, French, etc.) by defining the [`locale`](https://ej2.syncfusion.com/angular/documentation/api/image-editor/index-default#locale) value and a translation object.

The following list of properties and its values are used in the Angular Image Editor.
...
{% include code-snippet/image-editor/default-cs7/src/main.ts %}
{% endhighlight %}
{% endtabs %}
