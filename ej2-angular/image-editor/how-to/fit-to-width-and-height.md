...
The Angular Image Editor's [`zoom`](https://ej2.syncfusion.com/angular/documentation/api/image-editor#zoom) method can be used to fit an image to the editor by width or height. Programmatically increase the zoom level until the image dimensions match the editor container's width or height.
