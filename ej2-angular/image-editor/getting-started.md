...
This guide uses the [Angular Image Editor component](https://www.syncfusion.com/angular-components/angular-image-editor) for demonstration. Add the Angular Image Editor component component with:
...
- Add the `@syncfusion/ej2-angular-image-editor` package and peer dependencies to your `package.json`.
- Import the Image Editor component component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the Image Editor component:
