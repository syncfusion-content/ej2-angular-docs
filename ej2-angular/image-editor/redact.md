...
The Angular Image Editor control includes a [`getRedacts`](https://ej2.syncfusion.com/angular/documentation/api/image-editor/index-default#getredacts) method, which allows you to get all the redact details that are drawn on an image in the editor. It returns an array of `RedactSettings` objects describing each redact.
