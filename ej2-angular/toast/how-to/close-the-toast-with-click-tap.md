...
In default, Angular Toast gets expired based on timeOut value. You can customize Angular Toast hiding process, You can customize only hide with click/tap action by setting event args in [clicked](https://ej2.syncfusion.com/angular/documentation/api/toast/toastclickeventargs#clicktoclose) callback function with [static Angular Toast](../../toast/timeout#static-toast).
