...
Angular Toast can support to change templates in dynamically, with displaying in multiple toasts. We can change Angular Toast properties while calling in [`show`](https://ej2.syncfusion.com/angular/documentation/api/toast/index-default#show) method.
