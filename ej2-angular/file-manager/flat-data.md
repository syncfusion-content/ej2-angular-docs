...
description: Learn how to render flat JSON data in the Syncfusion Angular File Manager component using fileSystemData property without backend services.
