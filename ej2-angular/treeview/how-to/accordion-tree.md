...
1. **CSS class**: Apply a custom `cssClass` value (for example `accordion-tree`) on the Angular Tree View so you can scope styling.
...
The following example demonstrates how to configure a Angular Tree View component with accordion functionality:
