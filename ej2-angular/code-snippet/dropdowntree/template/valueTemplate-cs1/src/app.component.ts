...
standalone: true,
  ...
  template: `<ejs-dropdowntree id='dropdownTree' cssClass="custom" [fields]='fields' [popupHeight]='height' [placeholder]='watermark' [valueTemplate]='valueTemplate'></ejs-dropdowntree>`
})
export class AppComponent {
  ...
  public valueTemplate: string = '<div><span class="ename">${name} - </span><span class="ejob">${job}</span></div>';
}
