   ...
   fourthbtnclick() {
    ...
    onFirstKeyUp(e: any) {
        ...
        if (!value) {
            ...
            ((this.firstListObj as ListViewComponent).dataSource as any) = data;
        }
    }
    //Here, filtering is handled using the dataManager for the second list
     onSecondKeyUp(e:any) {
        ...
        if (!value) {
            ...
            (this.secondListObj as ListViewComponent).dataSource = data as { [key: string]: Object }[];
        }
    }

    //Here, the state of the button is changed
    setButtonState() {
        if (((this.firstListObj as ListViewComponent).dataSource as any).length) {
        ...
        if (((this.secondListObj as ListViewComponent).dataSource as any).length) {
