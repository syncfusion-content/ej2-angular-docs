...
export class AppComponent {
  ...
  private openaiApiKey: string = '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'; // Replace with your OpenAI API key (WARNING: Do not expose in client-side code for production)
