...
standalone: true,
    ...
    <e-chart3d-series-collection>
        <e-chart3d-series [dataSource]='dataSource' type='StackingColumn' xName='x' yName='y' name="General Motors" stackingGroup="A">
        </e-chart3d-series>
        <e-chart3d-series [dataSource]='dataSource' type='StackingColumn' xName='x' yName='y1' name="Honda" stackingGroup="A">
        </e-chart3d-series>
        <e-chart3d-series [dataSource]='dataSource' type='StackingColumn' xName='x' yName='y2' name="Suzuki" stackingGroup="B">
        </e-chart3d-series>
    </e-chart3d-series-collection>
</ejs-chart3d>`
})
