...
@Component({
    ...
    template: `<ejs-treegrid #treegrid [dataSource]="data" childMapping="children" [treeColumnIndex]="0" [height]="300" [enableColumnSpan]="true" [rowHeight]="50" gridLines="Both" clipMode="EllipsisWithTooltip" [allowSelection]="false" allowPaging="true" [pageSettings]="pageSettings">
                <e-columns>
