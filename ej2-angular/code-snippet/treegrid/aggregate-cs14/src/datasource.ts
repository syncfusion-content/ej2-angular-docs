export let summaryData: Object[] = [
    {
        ...
        category: 'Seafoods',
        subtasks: [
            { ID: '1.1', Name: 'Mackerel', category: 'Frozen seafood', units: '235', unitPrice: '12.26', price: 2881.1,subtasks: [
        
            { ID: '1.2', Name: 'Yellowfin Tuna', category: 'Frozen seafood', units: '324', unitPrice: '18.45', price: 5977 , subtasks: [
                { ID: '1.3', Name: 'Herrings', category: 'Frozen seafood', units: '288', unitPrice: '11.45', price: 5587.6,
    }]}]}]
    },
    {
        ID: '2',
