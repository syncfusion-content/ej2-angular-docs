...
export let projectData: Object[] = [
    ...
    EndDate: new Date('02/27/2017'), Progress: '40',Approved:true , parentID: null},
    { TaskID: 2, TaskName: 'Child Task 1', StartDate: new Date('02/23/2017'), Duration: 4, Priority : 'Low',
    EndDate: new Date('02/27/2017'), Progress: '40', parentID: 1, Approved:false},
    { TaskID: 3, TaskName: 'Child Task 2', StartDate: new Date('02/23/2017'), Duration: 2, Priority : 'Normal',
    EndDate: new Date('02/27/2017'), Progress: '40', parentID: 1,Approved:true },
    ...
    { TaskID: 16, TaskName: null, StartDate:null, Duration: null, Priority : null,
      EndDate: null, Progress: null, parentID: null },
    { TaskID: 17, TaskName: null, StartDate:null, Duration: null, Priority : null,
      EndDate: null, Progress: null, parentID: null },
    { TaskID: 5, TaskName: 'Parent Task 2', StartDate: new Date('03/14/2017'), Duration: 6, Priority : 'Normal',
    EndDate: new Date('03/18/2017'), Progress: '40',Approved:false , parentID: null},
    { TaskID: 6, TaskName: 'Child Task 1', StartDate: new Date('03/02/2017'), Duration: 11, Priority : 'High',
    EndDate: new Date('03/06/2017'), Progress: '40', parentID: 5,Approved:false },
    ...
    EndDate: new Date('03/06/2017'), Progress: '40', parentID: 5,Approved:true },
    ...
    EndDate: new Date('03/13/2017'), Progress: '40',Approved:false, parentID: null },
    { TaskID: 11, TaskName: 'Child Task 1', StartDate: new Date('03/9/2017'), Duration: 0, Priority : 'Low',
    EndDate: new Date('03/13/2017'), Progress: '40', parentID: 10 ,Approved:true},
    { TaskID: 12, TaskName: 'Child Task 2', StartDate: new Date('03/9/2017'), Duration: 10, Priority : 'Breaker',
    EndDate: new Date('03/13/2017'), Progress: '40', parentID: 10 ,Approved:false},
