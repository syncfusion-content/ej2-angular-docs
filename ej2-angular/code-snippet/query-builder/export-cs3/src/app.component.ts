...
standalone: true,
    ...
    template: `<!-- To render Query Builder. -->
              ...
              <button class="e-btn e-primary e-qb-button" (click)="getSql()" >Get Named Parameter Sql</button>
...
export class AppComponent implements OnInit {
    ...
    ngOnInit(): void {
     ...
     getSql(): void {
        this.Dialog!.content = JSON.stringify(this.qryBldrObj!.getParameterizedNamedSql(this.qryBldrObj!.getRules()), null, 2);
        this.Dialog!.show();
    }
     getJson(): void {
