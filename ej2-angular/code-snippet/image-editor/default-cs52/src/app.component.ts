...
standalone: true,
    ...
    template: `<div class="e-section-control">
              ...
              <div id="wrapperDiv" style="width:550px;height:350px;">
                <ejs-imageeditor #imageEditor (created)="created()" (selectionChanging)="selectionChanging($event)"></ejs-imageeditor>
              </div>
              </div>`
})
...
export class AppComponent {
    ...
    selectionChanging(args: SelectionChangeEventArgs | any): void {
