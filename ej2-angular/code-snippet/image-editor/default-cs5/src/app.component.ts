...
@Component({
  ...
  template: `<div class="e-section-control">
              ...
              <div id="wrapperDiv" style="width:550px;height:350px;">
                ...
                <button class="e-btn e-primary" (click)="drawShape()">Draw Shape</button>
                <button class="e-btn e-primary" (click)="deleteShape()">Delete Shape</button>
              </div>
              </div>`
})
...
export class AppComponent {
  ...
  drawShape(): void {
    if (this.imageEditorObj) {
      ...
      this.imageEditorObj.drawEllipse(dimension.x + 100, dimension.y + 100);
    }
  };
