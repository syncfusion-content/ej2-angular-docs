...
import { MultiColumnComboBoxComponent, SelectEventArgs } from '@syncfusion/ej2-angular-multicolumn-combobox';
...
@Component({
    ...
    template: `<ejs-multicolumncombobox id='multicolumn' #multicolumn [dataSource]='empData' [fields]='fields' (select)='select($event)' width='500px' text='Michael'>
                  <e-columns>
...
export class AppComponent {
    ...
    public select = (args: SelectEventArgs) => {
