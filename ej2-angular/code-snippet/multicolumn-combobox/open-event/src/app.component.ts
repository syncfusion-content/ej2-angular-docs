...
@Component({
    ...
    template: `<ejs-multicolumncombobox id='multicolumn' #multicolumn [dataSource]='empData' [fields]='fields' (open)='open($event)' width='500px' text='Michael'>
                  <e-columns>
...
export class AppComponent {
    ...
    public open = (args: PopupEventArgs) => {
