...
import { MultiColumnComboBoxComponent, PopupEventArgs } from '@syncfusion/ej2-angular-multicolumn-combobox';
...
@Component({
    ...
    template: `<ejs-multicolumncombobox id='multicolumn' #multicolumn [dataSource]='empData' [fields]='fields' (close)='close($event)' width='500px' text='Michael'>
                  <e-columns>
...
export class AppComponent {
    ...
    public close = (args: PopupEventArgs) => {
