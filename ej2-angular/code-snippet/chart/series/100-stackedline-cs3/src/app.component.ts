...
standalone: true,
    ...
    template: `<ejs-chart id="chart-container" [primaryXAxis]='primaryXAxis'[primaryYAxis]='primaryYAxis'>
        <e-series-collection>
            ...
            <e-series [dataSource]='chartData' type='StackingLine100' xName='x' yName='y' name='Peter' [marker]='marker dashArray='2,5'> </e-series>
            <e-series [dataSource]='chartData' type='StackingLine100' xName='x' yName='y' name='Steve' [marker]='marker' dashArray='2,5'> </e-series>
            <e-series [dataSource]='chartData' type='StackingLine100' xName='x' yName='y' name='Charle'[marker]='marker' dashArray='2,5'> </e-series>
        </e-series-collection>
    </ejs-chart>`
})
