...
standalone: true,
    ...
    template: `<ejs-chart id="chart-container" [primaryXAxis]='primaryXAxis'[primaryYAxis]='primaryYAxis'>
        <e-series-collection>
            <e-series [dataSource]='chartData' type='StackingLine100' xName='x' yName='y' name='John' width='2' [marker]='marker' fill='url(#gradient1)'> </e-series>
            <e-series [dataSource]='chartData' type='StackingLine100' xName='x' yName='y' name='Peter' width='2' [marker]='marker fill='url(#gradient2)'> </e-series>
            <e-series [dataSource]='chartData' type='StackingLine100' xName='x' yName='y' name='Steve' width='2' [marker]='marker' fill='url(#gradient3)'> </e-series>
            <e-series [dataSource]='chartData' type='StackingLine100' xName='x' yName='y' name='Charle' width='2' [marker]='marker' fill='url(#gradient4)'> </e-series>
        </e-series-collection>
    </ejs-chart>`
})
