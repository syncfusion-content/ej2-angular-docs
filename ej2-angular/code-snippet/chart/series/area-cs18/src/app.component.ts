...
import { AreaSeriesService, RangeAreaSeriesService, StepAreaSeriesService, StackingAreaSeriesService, 
    DateTimeService, CategoryService, MultiColoredAreaSeriesService, StackingStepAreaSeriesService, SplineRangeAreaSeriesService, ISeriesRenderEventArgs } from '@syncfusion/ej2-angular-charts'
...
standalone: true,
    ...
    template: `<ejs-chart id="chart-container" [primaryXAxis]='primaryXAxis'[primaryYAxis]='primaryYAxis' (seriesRender)="seriesRender($event)" [title]='title'>
        <e-series-collection>
