...
standalone: true,
    ...
    template: `<ejs-accumulationchart id="chart-container">
        <e-accumulation-series-collection>
            <e-accumulation-series  width='60%'  height='80%' type='Funnel' [dataSource]='funneldata' xName='x' yName='y' [dataLabel]='datalabel' funnelMode = 'Standard' ></e-accumulation-series>
        </e-accumulation-series-collection>
