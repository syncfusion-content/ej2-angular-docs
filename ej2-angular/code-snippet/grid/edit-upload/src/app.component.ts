...
import { EditService, GridModule, PageService, SortService, ToolbarService, EditSettingsModel,ToolbarItems,SaveEventArgs } from '@syncfusion/ej2-angular-grids';
import { FileInfo, SuccessEventArgs, TextBoxModule, UploaderModule } from '@syncfusion/ej2-angular-inputs';
