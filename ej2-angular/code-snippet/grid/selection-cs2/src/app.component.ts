...
@Component({
  ...
  template: `
        ...
        <ejs-switch id="switch" [(checked)]="enableToggleSelection" (change)="toggleColumnSelection()">
        </ejs-switch>
        </div>
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.data = data;
    this.selectionOptions = { type: 'Multiple',mode: 'Both', allowColumnSelection:true };
  }
