...
@Component({
  ...
  template: `
    <ejs-gantt height="370px" [dataSource]="data" [taskFields]="taskSettings" [allowFiltering]="true" [showColumnMenu]="true" [allowSorting]="true" [splitterSettings]="splitterSettings">
      <e-columns>
