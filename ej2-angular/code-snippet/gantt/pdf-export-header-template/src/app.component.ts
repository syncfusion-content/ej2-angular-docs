...
import {
  GanttComponent,
  ToolbarItem,
  PdfExportProperties,PdfColumnHeaderQueryCellInfoEventArgs
  ...
  template: `<ejs-gantt #ganttDefault id="ganttDefault" height="430px" [dataSource]="data"  [taskFields]="taskSettings" [toolbar]="toolbar" [labelSettings]="labelSettings" (pdfColumnHeaderQueryCellInfo)="pdfColumnHeaderQueryCellInfo($event)"
       ...
       <e-columns>
           <e-column field='TaskName' width='250'>
             ...
             <img
             src="https://ej2.syncfusion.com/angular/demos/assets/gantt/images/TaskNameDark.png"
             width="20"
             height="20"
           /> Task Name
             </ng-template>
...
export class AppComponent {
  ...
  public pdfColumnHeaderQueryCellInfo(args: PdfColumnHeaderQueryCellInfoEventArgs): void {
