...
export let editingData: Object[] = [
        ...
        subtasks: [
            {
                ...
                DurationUnit:'day', Progress: 30, resources: [1], info: 'Measure the total property area alloted for construction'
            },
            {
                TaskID: 3, TaskName: 'Perform Soil test', StartDate: new Date('04/02/2019'), Duration: 4, DurationUnit:'day', Predecessor: '2',
                resources: [2, 3, 5], info: 'Obtain an engineered soil test of lot where construction is planned.' +
                    'From an engineer or company specializing in soil testing'
            },
            { TaskID: 4, TaskName: 'Soil test approval', StartDate: new Date('04/02/2019'), Duration: 0, DurationUnit:'day', Predecessor: '3', Progress: 30 },
        ]
    },
    {
        TaskID: 5,
        ...
        subtasks: [
            {
                ...
                Duration: 3, DurationUnit:'day', Predecessor: '4', Progress: 30, resources: 4,
                info: 'Develop floor plans and obtain a materials list for estimations'
            },
            {
                TaskID: 7, TaskName: 'List materials', StartDate: new Date('04/04/2019'),
                Duration: 3, DurationUnit:'day', Predecessor: '6', resources: [4, 8], info: ''
            },
            {
                TaskID: 8, TaskName: 'Estimation approval', StartDate: new Date('04/04/2019'),
                Duration: 0, DurationUnit:'day', Predecessor: '7', resources: [12, 5], info: ''
            }
        ]
    },
    {
        TaskID: 9, TaskName: 'Sign Contract', StartDate: new Date('04/04/2019'), Duration: 1, DurationUnit:'day',
        ...
        subtasks: [
            {
                ...
                Duration: 2, DurationUnit:'day', Progress: 30, Predecessor: '9', resources: [6, 7],
            ...
            },
            {
                ...
                Duration: 2, DurationUnit:'day', Predecessor: '12', resources: [6, 7], info: ''
            },
        ]
    },
    {
        ...
        subtasks: [
            {
                ...
                Duration: 3, DurationUnit:'day', Progress: 30, Predecessor: '13', resources: [2, 8],
        ...
        subtasks: [
            {
                ...
                Duration: 3, DurationUnit:'day', Progress: 30, Predecessor: '19', resources: [4, 5],
            ...
            },
            {
                ...
                Duration: 3, DurationUnit:'day', Predecessor: '21', resources: [2, 3], info: 'Add floor and ceiling joists and install subfloor panels'
            },
            {
                TaskID: 23, TaskName: 'Add ceiling joists', StartDate: new Date('04/04/2019'),
                Duration: 3, DurationUnit:'day', Progress: 30, Predecessor: '22SS', resources: [5], info: ''
            },
            {
                TaskID: 24, TaskName: 'Install subfloor panels', StartDate: new Date('04/04/2019'),
                Duration: 3, DurationUnit:'day', Predecessor: '23', resources: [8, 9]
            },
            {
                TaskID: 25, TaskName: 'Frame floor walls', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
                Progress: 30, Predecessor: '24', resources: [10], info: ''
            },
            {
                TaskID: 26, TaskName: 'Frame floor decking', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
        ...
        subtasks: [
            {
                ...
                Duration: 3, DurationUnit:'day', Progress: 30, Predecessor: '26', resources: [2, 8],
            ...
            },
            {
                ...
                Duration: 3, DurationUnit:'day', Predecessor: '28', resources: [1, 10],
                info: 'Cover the walls with siding, typically vinyl, wood, or brick veneer but possibly stone or other materials'
            },
            {
                TaskID: 30, TaskName: 'Install roof shingles', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
                Progress: 30, Predecessor: '29', resources: [8, 9], info: 'Install roof shingles or other covering for flat roof'
            },
            { TaskID: 31, TaskName: 'Install windows', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day', Predecessor: '29', resources: 7 },
        ]
    },
    {
        TaskID: 32,
        ...
        subtasks: [
            {
                TaskID: 33, TaskName: 'Install internal plumbing', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
                Progress: 30, Predecessor: '26', resources: [1, 10]
            },
            {
                TaskID: 34, TaskName: 'Install HVAC', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day', Predecessor: '33',
                resources: [4, 9], info: 'Add internal plumbing, HVAC, electrical, and natural gas utilities'
            },
            {
                TaskID: 35, TaskName: 'Electrical utilities', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
                Progress: 30, Predecessor: '34'
            },
            {
                TaskID: 36, TaskName: 'Natural gas utilities', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
                Predecessor: '35', resources: 11
            },
            {
                TaskID: 37, TaskName: 'Install bathroom fixtures', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
        ...
        subtasks: [
            {
                ...
                Duration: 3, DurationUnit:'day', Progress: 30, Predecessor: '37', resources: [1, 8], info: 'Frame interior walls with wooden 2×4s'
            },
            {
                TaskID: 40, TaskName: 'Install  drywall panels', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
            ...
            {
                TaskID: 41, TaskName: 'Spackle', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
                Progress: 30, Predecessor: '40', resources: 10
            },
            {
                TaskID: 42, TaskName: 'Apply primer', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day',
                Predecessor: '41', resources: [10, 11]
            },
            {
                TaskID: 43, TaskName: 'Paint wall and ceilings', StartDate: new Date('04/04/2019'),
                Duration: 3, DurationUnit:'day', Progress: 30, Predecessor: '42', resources: [2, 9]
            },
            {
                TaskID: 44, TaskName: 'Install modular kitchen', StartDate: new Date('04/04/2019'),
                Duration: 3, DurationUnit:'day', Progress: 30, Predecessor: '43', resources: [5, 7]
            },
        ]
    },
    {
        ...
        subtasks: [
            {
                ...
                Duration: 3, DurationUnit:'day', Progress: 30, Predecessor: '44', resources: [4, 9, 3],
                info: 'Additional tiling on top of cementboard for wet areas, such as the bathroom and kitchen backsplash'
            },
            {
                TaskID: 47, TaskName: 'Tile floor', StartDate: new Date('04/04/2019'), Duration: 3, DurationUnit:'day', Predecessor: '46SS',
    ...
    },
    {
        ...
        subtasks: [
            {
                TaskID: 49, TaskName: 'Final inspection', StartDate: new Date('04/04/2019'), Duration: 2, DurationUnit:'day',
                Progress: 30, Predecessor: '47', resources: 12, info: 'Ensure the contracted items'
            },
            {
                TaskID: 50, TaskName: 'Cleanup for occupancy', StartDate: new Date('04/04/2019'), Duration: 2, DurationUnit:'day',
                Predecessor: '49', resources: [1, 5], info: 'Installation of major appliances'
            },
            {
                TaskID: 51, TaskName: 'Property Handover', StartDate: new Date('04/04/2019'), Duration: 0, DurationUnit:'day',
