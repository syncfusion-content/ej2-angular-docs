...
@Component({
    ...
    selector: 'app-root',
    template:
        `<ejs-gantt height="430px" [dataSource]="data" [taskFields]="taskSettings" (actionBegin)="actionBegin($event)" [editSettings]="editSettings" [resourceFields]="resourceFields" [resources]= "resources" [toolbar]="toolbar" [labelSettings]="labelSettings" [projectStartDate]="projectStartDate" [projectEndDate]="projectEndDate"></ejs-gantt>`,
...
export class AppComponent implements OnInit {
    ...
    public actionBegin(args: ActionBeginArgs) {
        ...
        args.requestType == 'beforeOpenEditDialog'
          ...
          (args as any).Resources.columns[1].visible = false;
        }
    }
}