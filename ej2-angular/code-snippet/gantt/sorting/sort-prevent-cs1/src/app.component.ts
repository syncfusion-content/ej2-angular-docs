...
@Component({
  ...
  template: `
    <ejs-gantt height="430px" [dataSource]="data" [taskFields]="taskSettings" [columns]="columns" [splitterSettings]="splitterSettings"
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.columns = [
      ...
      { field: 'TaskName', headerText: 'Task Name', width: '250', allowSorting: false },
