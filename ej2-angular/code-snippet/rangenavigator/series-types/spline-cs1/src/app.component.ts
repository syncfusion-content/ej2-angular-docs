...
import { SplineSeriesService, DateTimeService} from '@syncfusion/ej2-angular-charts'
...
standalone: true,
    ...
    template: `<ejs-rangenavigator id="rn-container" valueType='DateTime' [value]='value'>
            <e-rangenavigator-series-collection>
                <e-rangenavigator-series [dataSource]='chartData' type='Spline' xName='x' yName='y' width=2>
