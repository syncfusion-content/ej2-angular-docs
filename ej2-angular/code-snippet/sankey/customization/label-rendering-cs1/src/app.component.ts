  ...
  template: `
    <div class="control-pane">
      <div class="control-section" id="sankey-container">
        ...
        <ejs-sankey width="90%" height="450px" (labelRendering)="onLabelRendering($event)">
...
export class AppComponent implements OnInit {
  ...
  onLabelRendering(args: SankeyLabelRenderEventArgs): void {
    args.labelStyle.fontFamily = 'Arial';
    args.labelStyle.fontStyle = 'Normal';
    args.labelStyle.fontWeight = 'Bold';
    args.labelStyle.fontSize = '16px';
    args.labelStyle.color = '#000';
  }
}