...
import { SankeyLoadedEventArgs } from '@syncfusion/ej2-angular-charts';
  ...
  template: `
    <div class="control-pane">
      <div class="control-section" id="sankey-container">
        ...
        <ejs-sankey width="90%" height="450px" (load)="onLoad($event)">
...
export class AppComponent {
  onLoad(args: SankeyLoadedEventArgs): void {
