...
import { SankeyNodeEventArgs } from '@syncfusion/ej2-angular-charts';
...
export class AppComponent {
  ...
  onNodeMouseClick(args: SankeyNodeEventArgs): void {
    console.log('Node clicked:', args.node);
  }

  onNodeMouseEnter(args: SankeyNodeEventArgs): void {
