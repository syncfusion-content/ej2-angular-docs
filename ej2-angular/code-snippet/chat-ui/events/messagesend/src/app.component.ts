...
import { ChatUIModule, UserModel, MessageSendEventArgs } from '@syncfusion/ej2-angular-interactive-chat';
...
@Component({
    ...
    template: `<div id="chatui" ejs-chatui [user]="currentUserModel" (messageSend)="onMessageSend($event)">
        <e-messages>
