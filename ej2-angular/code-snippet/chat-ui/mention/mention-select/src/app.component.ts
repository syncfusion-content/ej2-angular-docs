import { ChatUIModule, MentionSelectEventArgs } from '@syncfusion/ej2-angular-interactive-chat';
...
@Component({
    ...
    template: `<div id="chatui" ejs-chatui [mentionUsers]="mentionUsers" (mentionSelect)="mentionSelect($event)">
        <e-messages>
...
export class AppComponent {
    ...
    public mentionUsers: UserModel[] = [this.currentUserModel, this.michaleUserModel];
    public mentionSelect = (args: MentionSelectEventArgs) => {
