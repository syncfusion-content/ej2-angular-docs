...
standalone: true,
    ...
    template: `<div class="e-section-control">
               ...
               <h4>Group A</h4>
               <ejs-listbox [dataSource]="groupA" [fields]="setfield" height="330px" [toolbarSettings]="toolbar" scope="#listbox" [allowDragAndDrop]='true'></ejs-listbox>
               </div>
               <div class="dual-list-groupb">
               <h4>Group B</h4>
               <ejs-listbox [dataSource]="groupB" [fields]="setfield" height="330px" id="listbox" scope="#listbox" [allowDragAndDrop]='true'></ejs-listbox>
               </div></div>
               </div>`,
