...
import { DiagramComponent, Diagram, NodeModel, ConnectorModel, PointPortModel, PortVisibility,connectionDirection, ShapeStyleModel } from '@syncfusion/ej2-angular-diagrams';
