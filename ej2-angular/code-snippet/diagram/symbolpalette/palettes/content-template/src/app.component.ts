...
export class AppComponent {
    ...
    public template(obj: any): string {
        if (obj === 'node1') {
            return `<div style=" height:100%; background:#e3daf1;font-family:Arial;padding-top:5px;">
                        <div style="font-size:12px;font-weight:bold;margin-left:3px;padding-top:5px;">📅Meeting</div>
