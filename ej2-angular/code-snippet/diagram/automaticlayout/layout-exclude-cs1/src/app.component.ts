...
import { DiagramModule, DiagramComponent, Diagram, NodeModel, ConnectorModel, LayoutModel,
  DataSourceModel, DataBinding, HierarchicalTree } from '@syncfusion/ej2-angular-diagrams';
