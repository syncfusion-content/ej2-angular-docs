...
import { DiagramComponent, DiagramModule, UserHandleModel, SelectorModel } from '@syncfusion/ej2-angular-diagrams';
...
@Component({
  ...
  template: `
    <ejs-diagram #diagram id="diagram" width="100%" height="600px" [selectedItems]='selectedItems'>
      <e-nodes>
        <e-node id='node1' [offsetX]=100 [offsetY]=100 [height]=100 [width]= 100></e-node>
      </e-nodes>
    </ejs-diagram>
  `,
