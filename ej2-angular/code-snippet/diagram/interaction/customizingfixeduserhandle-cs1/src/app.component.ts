        ...
        <e-connectors>
            <e-connector id='connector' [sourcePoint]='sourcePoint1' [targetPoint]='targetPoint1'  >
                <e-connector-fixeduserhandles>
                    <e-connector-fixeduserhandle id='stroke' [width]=30 [height]=25 [offset] = 0.5  [handleStrokeColor]="handleStrokeColor1" [handleStrokeWidth] = 4 [iconStrokeColor]="iconStrokeColor1" [iconStrokeWidth] = 1 
                    [fill]="fill1" [cornerRadius]= 5 pathData= 'M0,13.85 L15.62,13.85 L15.62,20 L25,9.74 L15.62,0 L15.62,6.41 L0,6.41 L0,13.85 Z '  >
