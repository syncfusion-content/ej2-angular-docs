...
standalone: true,
    ...
    <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6">
      ...
      <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6">
      <div class='custom_drop'><ejs-dropdownlist #expandAnimation (change)='expandAnimationChange($event)' index='0' [dataSource]='expandAni' placeholder='Expand Animation'></ejs-dropdownlist></div>
    </div></div>
    <div class='row'>
    <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6">
    <label> Collapse Animation </label></div>
    <div class="col-xs-6 col-sm-6 col-lg-6 col-md-6">
    <div class='custom_drop'><ejs-dropdownlist #collapseAnimation (change)='collapseAnimationChange($event)' index='1' [dataSource]='expandAni' placeholder='Collapse Animation'></ejs-dropdownlist></div>
    </div></div>
    <div style='padding-top: 25px'>
...
export class AppComponent {
    ...
    public expandAnimationChange(args: ChangeEventArgs): void {
      (this.acrdnInstance as AccordionComponent).animation.expand = { effect: args.value as Effect }
    }
    public collapseAnimationChange(args: ChangeEventArgs): void {
      (this.acrdnInstance as AccordionComponent).animation.collapse = { effect: args.value as Effect }
    }
}
