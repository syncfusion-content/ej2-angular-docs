...
@Component({
    standalone: true,
    selector: 'app-root',
    template: `<div class="control-section e-rte-mention-format-section">
    <div class="sample-container">
        <div class="default-section">
            <ejs-richtexteditor id="slashMenuEditor" #slashMenuEditor [toolbarSettings]='tools'
                placeholder="Type '/' and choose format" [slashMenuSettings]="slashMenuSettings"
                (slashMenuItemSelect)="onSlashMenuItemSelect($event)">
            </ejs-richtexteditor>
        </div>
    </div>
</div>`,
