...
import { RichTextEditorModule, ToolbarService, LinkService, AudioService, HtmlEditorService, QuickToolbarService, TableService, PasteCleanupService } from '@syncfusion/ej2-angular-richtexteditor';
...
@Component({
    ...
    standalone: true,
    selector: 'app-root',
    template: `<ejs-richtexteditor [insertAudioSettings]='insertAudioSettings' [(value)]='value'></ejs-richtexteditor>`,
    providers: [ToolbarService, LinkService, AudioService, HtmlEditorService, QuickToolbarService, TableService, PasteCleanupService]
})
