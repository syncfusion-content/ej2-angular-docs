...
import { RichTextEditorModule, ToolbarService, LinkService, VideoService, HtmlEditorService, QuickToolbarService, TableService, PasteCleanupService } from '@syncfusion/ej2-angular-richtexteditor';
...
@Component({
    ...
    standalone: true,
    selector: 'app-root',
    template: `<ejs-richtexteditor [insertVideoSettings]='insertVideoSettings' [(value)]='value'></ejs-richtexteditor>`,
    providers: [ToolbarService, LinkService, VideoService, HtmlEditorService, QuickToolbarService, TableService, PasteCleanupService]
})
