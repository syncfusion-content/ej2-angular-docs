...
@Component({
  selector: 'app-root',
  template: `  <ejs-richtexteditor id="mailMergeEditor" #mailMergeEditor [value]="rteValue" [toolbarSettings]="tools"
...
export class AppComponent {
  @ViewChild('mailMergeEditor', { static: false })
  public mailMergeEditor!: RichTextEditorComponent;
  ...
  onClickHandler(): void {
    if (this.mailMergeEditor) {
      ...
      if (
        (this.mailMergeEditor as any).formatter.getUndoRedoStack().length === 0
      ) {
