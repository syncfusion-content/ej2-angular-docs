...
import { RichTextEditorModule, ToolbarService, LinkService, NodeSelection, ImageService, HtmlEditorService, QuickToolbarService, PasteCleanupService, RichTextEditorComponent, ContentRender } from '@syncfusion/ej2-angular-richtexteditor';
...
@Component({
  ...
  <div><br/><input id="btn" class="e-btn" type="button" value="Set cursor point" /></div>`,
