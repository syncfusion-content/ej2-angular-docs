...
import { ToolbarService, LinkService, ImageService, QuickToolbarService, PasteCleanupService, HtmlEditorService, RichTextEditorComponent } from '@syncfusion/ej2-angular-richtexteditor';
...
@Component({
  ...
  providers: [ToolbarService, LinkService, ImageService, HtmlEditorService, PasteCleanupService, QuickToolbarService]
})
