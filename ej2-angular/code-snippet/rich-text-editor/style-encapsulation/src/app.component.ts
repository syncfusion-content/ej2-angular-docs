...
import { QuickToolbarService, ToolbarService, PasteCleanupService, LinkService, ImageService, HtmlEditorService, IFrameSettingsModel } from '@syncfusion/ej2-angular-richtexteditor';
...
@Component({
   ...
   providers: [ToolbarService, LinkService, ImageService, QuickToolbarService, HtmlEditorService, PasteCleanupService],
