...
The Angular Tab component provides flexible height management through the [`heightAdjustMode`](https://ej2.syncfusion.com/angular/documentation/api/tab/tabModel#heightadjustmode) property, which controls how Angular Tab content areas calculate and display their heights. By default, the [`heightAdjustMode`](https://ej2.syncfusion.com/angular/documentation/api/tab/tabModel#heightadjustmode) property is set to `Content`.

## Height adjustment modes

The Angular Tab component offers four distinct height calculation strategies to accommodate different layout requirements:
