...
You can bind any data object to Angular Tab items by mapping the data to the [`header`](https://ej2.syncfusion.com/angular/documentation/api/tab/tabItemDirective/#header) and [`content`](https://ej2.syncfusion.com/angular/documentation/api/tab/tabItemDirective/#content) properties.
...
2. Bind the result to the Angular Tab's [`items`](https://ej2.syncfusion.com/angular/documentation/api/tab/tabModel/#items) property after the request resolves.
