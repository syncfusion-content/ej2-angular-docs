...
description: Learn here all about create wizard using tab in Syncfusion Essential Angular Tab component, it's elements and more.
...
{% include code-snippet/tab/wizard-cs1/src/app.module.ts %}
{% endhighlight %}
