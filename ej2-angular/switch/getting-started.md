...
This guide demonstrates how to create a simple Switch and demonstrates the basic usage of the Switch component in an Angular application.
...
This guide uses the [Angular Switch component](https://www.syncfusion.com/angular-components/angular-toggle-switch-button) for demonstration. Add the Angular Switch component component with:
...
- Import the Switch component component in your application.
...
To stylize only specific Syncfusion<sup style="font-size:70%">&reg;</sup> components, import the necessary styles. For example, to style only the Switch component:
