...
## Adding the Syncfusion<sup style="font-size:70%">&reg;</sup> Angular Switch package
...
> For the full property list, see the [Switch API reference](https://ej2.syncfusion.com/angular/documentation/api/switch/index-default).
