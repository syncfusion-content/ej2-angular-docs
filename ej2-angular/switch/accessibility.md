---
layout: post
title: Accessibility in Angular Toggle Switch Button | Syncfusion
description: Learn about accessibility support in Angular Toggle Switch Button, including keyboard navigation and ARIA roles.
